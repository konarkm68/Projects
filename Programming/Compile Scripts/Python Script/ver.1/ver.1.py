...
console_lbl=Label(master,text='Do you want the console ?',bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5,relief='groove')
...
onefile_lbl=Label(master,text='Do you want package in one file ?',bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5,relief='groove')
...
onedir_lbl=Label(master,text='Do you want package in one directory ?',bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5,relief='groove')
...
icon_lbl=Label(master,text='Do you want an icon ?',bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5,relief='groove')
...
def select_icon_file():
    if icon.get()=='NO':
        ...
        icon_file=filedialog.askopenfilename(parent=master,filetypes=[('Icon Files','.ico')])
        if icon_file=='':
            icon.current(1)
        else:
...
select_icon_btn=Button(master,text='Select file: ',command=select_icon_file,bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5)
...
def select_file():
    file=filedialog.askopenfilename(parent=master,filetypes=[('Python Files','.py')])
    if file=='':
        ...
        comboboxes={'console':console.get(),'onefile':onefile.get(),'onedir':onedir.get(),'icon':icon.get()}
        ...
        os.chdir(file_path)
        os.system(query)
convert=Button(master,text='Start the process...',command=select_file,bg='blue',fg='yellow',font=('Comic Sans MS',14,'bold'),bd=5)
