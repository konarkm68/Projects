...
def main(page: flet.Page):
    ...
    def generate_ico():
        ...
        if image_file.value == "None":
            page.snack_bar.content = flet.Text(
                f"Error! - Please select an Image-File!",
                size=10,
                color="red",
                weight="bold",
            )
            ...
            try:
                ...
                if result == 0:
                    ...
                    page.snack_bar.content = flet.Text(
                        f"Success! - Your .ico file is located in {WEB_SERVER_ROOT}",
                        size=10,
                        color="green",
                    )
    ...
    gen_ico_btn = flet.FilledButton(
        "Generate Icon File (.ico)!",
        on_click=lambda _: generate_ico(),
        width=400,
        height=40,
    )
    ...
    page.add(
        flet.Column(
            [
                ...
                flet.Row([flet.Text("Selected Image File:"), image_file]),
                gen_ico_btn,
                progress_bar,
            ]
        )
