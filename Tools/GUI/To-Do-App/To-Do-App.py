    ...
    def build(self):
        ...
        self.display_view = flet.Row(
            ...
            controls=[
                ...
                flet.Row(
                    controls=[
                        flet.IconButton(
                            icon=flet.icons.CREATE_OUTLINED,
                            icon_color=flet.colors.BLUE,
                            tooltip="Edit Task",
        ...
        self.edit_view = flet.Row(
            ...
            controls=[
                self.edit_name,
                flet.IconButton(
                    icon=flet.icons.DONE_OUTLINE_OUTLINED,
...
class TDApp(flet.UserControl):
    def build(self):
        ...
        self.filter = flet.Tabs(
            ...
            tabs=[
                flet.Tab(text="All"),
                flet.Tab(text="Active"),
                flet.Tab(text="Completed"),
            ],
        )
        ...
        return flet.Column(
            controls=[
                flet.Row(
                    [
                        flet.Text(
                            value="To-Do App", style=flet.TextThemeStyle.HEADLINE_MEDIUM
                        )
                    ],
                ...
                flet.Row(
                    controls=[
                        ...
                        flet.FloatingActionButton(
                            icon=flet.icons.ADD, on_click=self.add_clicked, height=80
                        ),
                    ],
                ),
                flet.Column(
